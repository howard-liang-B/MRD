...
def get_images(root_path):
    train_images = glob.glob(f"{root_path}/train_image/*")
    train_images.sort()
    train_masks = glob.glob(f"{root_path}/train_mask/*")
    train_masks.sort()
    valid_images = glob.glob(f"{root_path}/valid_image/*")
    valid_images.sort()
    valid_masks = glob.glob(f"{root_path}/valid_mask/*")
    valid_masks.sort()
